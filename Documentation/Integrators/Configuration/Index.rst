...
-   `Creating the Pages and sysfolder`_

    -   Sysfolder_
    -   `Root Category`_
    -   `Include static from extension`_
    -   `Extension manager`_
    -   `Create page and add plugin`_
    -   `Product list view`_
    -   `Lazy loading view`_
    -   `Wish list`_
    -   `Compare view`_
    -   `Product single view page`_
    -   Navigation_
    -   Breadcrumb_
...
-   `Linking products and categories in CKEditor`_
