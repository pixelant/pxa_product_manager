        ...
        'columns' => [
            ...
            'l10n_parent' => [
                ...
                'config' => [
                    ...
                    'foreign_table_where' => 'AND tx_pxaproductmanager_domain_model_link.uid=###REC_FIELD_l10n_parent### AND tx_pxaproductmanager_domain_model_link.sys_language_uid IN (-1,0)',
                    'default' => 0
                ],
            ],
            'l10n_diffsource' => [
